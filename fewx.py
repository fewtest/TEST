...
RfuBot=[lineMID]
Family=["ucb66ed3232f6fcd92a5483e525ebd295",lineMID]
admin=['ucb66ed3232f6fcd92a5483e525ebd295',lineMID]
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message":"Thanks for add me Selfbot By FEWX",
    "comment":"Thanks for add me Selfbot By FEWX",
...
def myhelp():
    myHelp =      " 【คำสั่ง\n[BY.FEWX]】"+ "  \n" + \
                  " ⍤⃝˳ ༘*คำสั่งแปล  ➾ เรียกดูคำสั่งแปล💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รีบูส  ➾ รูบูสระบบ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คออน์   ➾ เช็คเวลาทำงานบอท💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ไลน์  ➾ เช็คข้อมูลไลน์💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คตั้งค่า  ➾ เช็คระบบตั้งค่า💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ไอดี  ➾ ดูmid💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ชื่อ  ➾ ดูชื่อไลน💗】"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูป  ➾ ดึงรูป】"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูปวิดีโอ  ➾ ดึงวิดีโอ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูปปก  ➾ ดึงปก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*คท @  ➾ ดึงคอนแทค💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ชื่อ @  ➾ ดึงชื่อ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ตัส @  ➾ ดึงตัส💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูป @  ➾ ดึงรูป💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูปวิดีโอ @  ➾ ดึงรูปวิดีโอ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ปก @  ➾ ดึงปก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*คืนร่าง  ➾ กลับร่างเดิม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เลียนแบบ @  ➾ เพิ่มพูดตาม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เลียนแบบลบ @  ➾ ลบพูดตาม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คเลียนแบบ  ➾ เช็คชื่อพูดตาม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คแอด  ➾ เช็คแอดห้อง】"+ "  \n" + \
                  " ⍤⃝˳ ༘*ไอดีกลุ่ม  ➾ GID กลุ่ม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูปกลุ่ม  ➾ ดึงรูปห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ชื่อกลุ่ม  ➾ ดึงชื่อห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ขอลิ้งค์  ➾ เอาลิ้งค์ห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เปิดลิ้งค์  ➾ เปิดลิ้งค์ห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ปิดลิ้งค์  ➾ ปิดลิ้งค์ห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ข้อมูลกลุ่ม  ➾ เช็ครายละเอียดห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*สมาชิก  ➾ ชื่อสมาชิก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*กลุ่ม  ➾ เช็ครายชื่อกลุ่ม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*1กลุ่ม  ➾ คลิ้ก1 เช็ครายชื่อกลุ่ม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*2กลุ่ม ➾ คลิ้ก2 เช็ครายชื่อกลุ่ม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*3กลุ่ม  ➾ คลิ้ก3 เช็ครายชื่อกลุ่ม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*แท็ก  ➾ สั่งแท็คคนทั้งหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คอ่าน  ➾ เปิดระบบอ่าน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อ่าน  ➾ ดูรายชื่อคนอ่าน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ค้นหารูป ➾ ค้นหารูปจากgoogle💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ค้นหาอินสตาแกรม  ➾ หาอินสตาแกรม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รูปการตูน  ➾ ค้นหารูปจากgoogle💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ค้นหายูทูป  ➾ ค้นหายูทูป💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รายการเพื่อน  ➾ เช็ครายชื่อเพื่อนเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รายการบล็อค  ➾ รายการกดบล็อค💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*รายการmid  ➾ รายการmidเพื่อนทั้งหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เชิญกุ  ➾ เชิญคนเขียนบอท💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ออก  ➾ สั่งตัวเองออกจากห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ออก1  ➾ สั่งคลิ้กออก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ลบรัน  ➾ ลบห้องรัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เชิญ  ➾  เชิญด้วยคท💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เตะ @  ➾ ลบคน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เชิญ @  ➾ เชิญคน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*1เชิญ @  ➾ สั่งคลิ้กเชิญ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*2เชิญ @  ➾ สั่งคลิ้กเชิญ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*3เชิญ @  ➾ สั่งคลิ้กเชิญ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เตะดำ  ➾ เตะรายการบชดำ"+ "  \n" + \
                  " ⍤⃝˳ ༘*ลบแชท  ➾ สั่งลบแชททั้งหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ออกแชทรวม  ➾ ออกจากแชทรวมออโต้💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อัพตัส:   ➾ เปลี่ยนตัสเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อัพชื่อ:   ➾ เปลี่ยนชื่อเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ชื่อคลิ้ก   ➾ เปลี่ยนชื่อคลิ้ก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ตัสคลิ้ก   ➾ เปลี่ยนตัส💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*1ลบรัน  ➾ ลบรัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คดำ  ➾ เช็ครายการดำ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*บล็อคเปิด  ➾ ออโต้บล้อคเปิด"+ "  \n" + \
                  " ⍤⃝˳ ༘*บล็อคปิด  ➾ ออโต้บล็อคปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เข้าเปิด  ➾ เข้าห้องออโต้เปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เข้าปิด  ➾ เข้าห้องออโต้ปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*แชทรวมเปิด  ➾ กันดึงแชทรวมเปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*แชทรวมปิด  ➾ กันดึงแชทรวมปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อ่านเปิด  ➾ เปิดระบบอ่าน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อ่านปิด  ➾ ปิดระบบอ่าน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คติ้กเปิด  ➾ ระบบเช็คติ้กเปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็คติ้กปิด  ➾ ระบบเช็คติ้กปิด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เปิดหมด  ➾ เปิดระบบกันหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ปิดหมด  ➾ ปิดระบบกันหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เปิดคนเข้า  ➾ เปิดระบบต้อนรับ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ปิดคนเข้า  ➾ ปิดระบบต้อนรับ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เปิดคนออก  ➾ เปิดระบบต้อนรับ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ปิดคนออก  ➾ ปิดระบบต้อนรับ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ทักออก:   ➾ ตั้งข้อความทักคนเข้า💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ทักเข้า:  ➾ ตั้งข้อความทักคนออก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ตั้งแท็ก:   ➾ ตั้งข้อความทักคนแท็ก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ลบเชิญs ➾ ลบค้างเชิญ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*เช็ค   ➾ตรวจจับคนอ่าน 💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*อ่าน   ➾รายชื่อคนอ่าน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*urban   ➾ขาว 💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Gcancel: on  ➾ เปิดระบบยกเลิกห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Gcancel: off  ➾ ปิดระบบยกเลิกห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Copy @  ➾ คัดลอกคนอื่น💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*me  ➾ คทเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ME  ➾ คทเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Me  ➾ คทเรา💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*zt  ➾ ดูคนไส่ล่องหน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*zm  ➾ ดูคนไส่ล่องหน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*zc  ➾ ดูคนไส่ล่องหน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Allban  ➾ แบนหมด💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*ban @  ➾ บชดำ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*unban @  ➾ บชขาว💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*video @  ➾ ดึงรูปวิดีโอ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*mimic on  ➾ เปิดระบบพูดตาม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*mimic off  ➾ ปิดระบบพูดตาม💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Bcvoice  +ข้อความ  ➾ ดึงmid💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Cbcvoice   ➾ ส่งmp3ทุกห้อง💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Dow  +ข้อความ  ➾ เปลี่ยนไอดีไลน์💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Day  ➾ เช็ควันและเดือน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Spam  on +เลข+ข้อความ💗  ➾ "+ "  \n" + \
                  " ⍤⃝˳ ༘*cb  ➾ ล้างบชดำ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*มาหำ  ➾ สั่งคลิ้กเข้า💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*1-3 @  ➾ สั่งคลิ้กเตะ💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*Cleanse  ➾ สั่งคลิ้กบิน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*protect on  ➾ เปิดป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*protect off  ➾ ปิดป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*cancel on  ➾ เปิดยกเลิกป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*cancel off  ➾ ปิดยกเลิกป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*invit on  ➾ เปิดเชิญป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*invit off  ➾ ปิดเชิญป้องกัน💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*link on  ➾ เปิดป้องกันลิ้งค์💗"+ "  \n" + \
                  "⍤⃝˳ ༘*link off  ➾ ปิดป้องกันลิ้งค์💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*guest on  ➾ เปิดป้องกันสมาชิก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*guest off  ➾ ปิดป้องกันสมาชิก💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*join on  ➾ เปิดป้องกันคนเข้า💗"+ "  \n" + \
                  " ⍤⃝˳ ༘*join off  ➾ ปิดป้องกันคนเข้า💗"+ "  \n" + \
                  "[FEWX]🙌เปิดให้บริการแล้ว\n{http://line.me/ti/p/~fewtestbot  }"
    return myHelp
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "ออโต้แอด ★ เปิด")
                elif text.lower() == 'add off':
                    settings["autoAdd"] = False
                    line.sendMessage(to, "ออโต้แอด ★ ปิด")
...
#===================================================================#              
                    ...
                    line.sendMessage(msg.to,"   BY.นายมิน]")
                elif msg.text in ["อ่านออโต้ปิด"]:
                    if msg.to in RfuCctv['point']:
                        RfuCctv['cyduk'][msg.to]=False
                        line.sendText(msg.to, RfuCctv['sidermem'][msg.to])
                    else:
                        line.sendMessage(msg.to, "   ⚔️[BY.นายมิน]")
...
#โค๊ตใหม่
                ...
                line.sendMessage(msg.to,"เชิญเข้าร่วมการคอลเรียบร้อย(｀・ω・´)")
                ...
                if msg.to in mentmedat and mentmedat[msg.to] != []:
                    ...
                    line.sendMessage(msg.to,"ไม่มีการกล่าวถึงก่อนหน้านี้(｀・ω・´)")

            elif msg.text.lower() == "!retag1":
                dkey = mentmedat.pop(msg.to,None)
                line.sendMessage(msg.to,"รีเซ็ตข้อมูลการกล่าวถึงเรียบร้อยแล้ว")


            elif msg.text.lower() == "!retag":
                mentmedat = {}
                line.sendMessage(msg.to,"รีเซ็ตข้อมูลการกล่าวถึงทั้งหมดแล้ว")          
